...
if(isset($_POST['registrasi'])){
    ...
    if(insertDetails($con,$username,$email,$password));
    {
        ...
        header("Location: indexpuswil.php");
    }
...
if(isset($_POST['tambah'])){
    ...
    $sql= "INSERT INTO buku (nama,kodebuku,judulbuku,pengarang,penerbit,tahunterbit,tglpinjam,tglkembali) 
    
    VALUES(:nama,:kodebuku,:judulbuku,:pengarang,:penerbit,:tahunterbit,:tglpinjam,:tglkembali)";
    ...
    if($lastInsertId){
        ...
        echo "<script>alert('Buku berhasil dipilih');</script>";
